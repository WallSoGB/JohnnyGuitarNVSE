...
// GAME - 0x403C60
bool EffectSetting::IsAssociatedActorValueUsed() const {
#ifdef GAME
    return ThisCall<bool>(0x403C60, this);
#else
    return EffectArchetypes::IsFlagSet(GetEffectArchetype(), EffectArchetypes::Flags::ASSOCIATED_ACTOR_VALUE);
#endif
}
...
#else
    return ThisCall<BSString>(0x4395F0, this);
#endif
}
