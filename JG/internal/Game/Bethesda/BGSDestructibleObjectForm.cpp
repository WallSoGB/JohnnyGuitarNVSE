...
// GECK - 0x4CDC30
uint32_t BGSDestructibleObjectForm::GetNumStages() const {
	if (pData)
		return pData->ucNumStages;
	return 0;
}
...
bool BGSDestructibleObjectForm::GetTargetableInVATS() const {
	return ThisCall<bool>(0x576100, this);
}
...
#else
	return CdeclCall<BGSDestructibleObjectForm*>(0x4E3BF0, apForm);
#endif
}